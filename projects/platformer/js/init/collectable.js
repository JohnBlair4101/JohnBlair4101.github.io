(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.steve, 100,50,5,0.9);
        collectable.create(type.grace, 50,50,1,0.2);
        collectable.create(type.db, 80,80,1,0.6 )
        collectable.create(type.max, 90,40,3,0.9)
